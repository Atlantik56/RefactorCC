...
VeloCore is a Next.js static-export promo site for a cycling club. The project keeps the original visual direction and local assets while using App Router pages for GitHub Pages deployment.

## Current Status

- Main branch: `main`
- Production: pending VeloCore domain
...
- deploy base path is configurable with `NEXT_PUBLIC_BASE_PATH` and defaults to root
